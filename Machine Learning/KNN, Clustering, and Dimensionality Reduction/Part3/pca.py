...
###PCA is
#the simplest among them and aims to linearly project data instances onto particular vectors such that
#the projected data instances have the highest variance (scatter) ([2] Chapter 6), which turns out to find
#eigenvectors of the covariance matrix of data instances.